...
_MOD  = os.path.dirname(os.path.abspath(__file__))
sys.path.insert(0, _ROOT)
sys.path.insert(0, _MOD)
from shared.telegram_notifier import send_lern_message
from lernbot_quiz import FRAGEN, THEMEN
import json, os

TRACKER = os.path.join(_ROOT, "shared", "daten", "lernbot_tracker.json")
