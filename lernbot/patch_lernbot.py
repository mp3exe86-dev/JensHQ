...
with open('/home/jens/JobAgent/lernbot/lernbot_service.py', 'r', encoding='utf-8') as f:
    c = f.read()
...
with open('/home/jens/JobAgent/lernbot/lernbot_service.py', 'w', encoding='utf-8') as f:
    f.write(c)
