...
MIN_MARKTWERT = 20.0   # Nur Karten mit Trendpreis >= 20€
RABATT_MIN    = 0.33   # 33% unter Marktwert
...
def build_deal_message(alle_deals: list) -> str:
    ...
    for i, deal in enumerate(alle_deals[:10], 1):
