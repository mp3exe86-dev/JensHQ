...
#  PROFIL LADEN
# ──────────────────────────────────────────────────────────
PROFIL_PFAD = "/home/jens/JobAgent/daten/skills_profile.json"
...
#  LOGGING
# ──────────────────────────────────────────────────────────
Path("/home/jens/JobAgent/logs").mkdir(parents=True, exist_ok=True)
logging.basicConfig(
    level=logging.INFO,
    format="%(asctime)s [%(levelname)s] %(message)s",
    handlers=[
        logging.FileHandler("/home/jens/JobAgent/logs/jobfinder.log", encoding="utf-8"),
...
def run_jobfinder():
    ...
    # CSV schreiben
    Path("/home/jens/JobAgent/jobs").mkdir(parents=True, exist_ok=True)
